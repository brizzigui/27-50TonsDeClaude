...
import {
  ...
  CheckCircle, AlertCircle, XCircle, RefreshCw, X, Ruler
} from "lucide-react";
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="w-[42%] min-w-[320px] flex flex-col border-r border-gray-200 bg-white">
        ...
        {/* Legend */}
        <div className="flex gap-4 px-5 py-2.5 bg-gray-50 border-b border-gray-100">
        ...
        {/* Summary bar */}
        <div className="border-t border-gray-100 px-5 py-3 bg-gray-50 flex gap-5">
      ...
      <div className="flex-1 flex flex-col bg-[#f7f9f4] overflow-y-auto">
        ...
        <div className="px-6 py-5 bg-white border-b border-gray-100">
          <div className="flex items-start justify-between">
            ...
            <Button
              onClick={openModal}
              className="bg-green-700 hover:bg-green-800 text-white gap-2 shrink-0"
            >
              <RefreshCw size={15} />
              Atualizar Leitura
            </Button>
        ...
        <div className="flex-1 p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Status de Saúde */}
            <div className={`rounded-xl p-5 border shadow-sm ${cfg.bgLight} ${cfg.border}`}>
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
            ...
            <div className="flex justify-between text-xs text-gray-400 mt-1.5">
              <span>0%</span>
              <span className="text-amber-500">40% — Atenção</span>
              <span className="text-emerald-600">70% — Ideal</span>
              <span>100%</span>
            </div>
              ...
              <div className="space-y-2">
                ...
                {photoPreview ? (
                  ...
                  <div
                    ...
                    className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center cursor-pointer hover:border-green-400 hover:bg-green-50/30 transition-all group"
                  >
