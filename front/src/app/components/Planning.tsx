...
export function Planning() {
  ...
  return (
    <div className="flex h-full overflow-hidden bg-[#f7f9f4]">
      {/* LEFT: Timeline */}
      <div className="w-[42%] min-w-[320px] flex flex-col bg-white border-r border-gray-200">
        ...
        <div className="flex gap-2 px-5 py-3 border-b border-gray-100 bg-gray-50">
          {Object.entries(actionConfig).map(([key, val]) => (
            <div key={key} className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs ${val.bg} ${val.color} border ${val.border}`}>
              <val.Icon size={11} />
              {val.label}
            </div>
          ))}
        ...
        <div className="flex-1 overflow-y-auto py-2">
          <div className="relative">
            ...
            {TIMELINE.map((event, i) => {
              ...
              return (
                <div key={event.id} className="flex gap-0 px-4 py-2 group">
                  {/* Left: date + icon */}
                  ...
                  {/* Right: card */}
                  <div className={`
                    flex-1 rounded-xl border p-3.5 mb-1 ml-2 transition-all cursor-pointer
                    ${event.urgent
                  ...
                  `}>
                    ...
                    {/* Detail */}
                    <div className={`flex items-center gap-1.5 mb-2 text-sm ${event.urgent ? "text-gray-700" : "text-gray-600"}`}>
        ...
        <div className="flex-1 p-6 space-y-5">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h3 className="text-gray-800">Projeção de Ganho de Peso Acumulado</h3>
            ...
            <ResponsiveContainer width="100%" height={260}>
              <LineChart data={WEIGHT_DATA} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
                <defs>
